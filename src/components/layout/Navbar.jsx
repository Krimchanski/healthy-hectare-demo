...
export default function Navbar() {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 z-[1000] bg-white/90 backdrop-blur border-b border-neutral-200">
            ...
            {/* Mobile menu layers (outside header container, guaranteed to cover viewport) */}
            {open && (
                <>
                    {/* Overlay */}
                    <div
                        className="lg:hidden fixed inset-0 z-[1100] bg-black/25 pointer-events-auto"
                    ...
                    <div
                        id="mobile-menu"
                        className="lg:hidden fixed left-0 right-0 top-16 z-[1200] bg-white border-b border-neutral-200 pointer-events-auto"
                        role="dialog"
                        aria-modal="true"
                    >
                        <div className="max-w-7xl mx-auto px-6 py-4">
                            <div className="grid gap-3">
                                ...
                                <Link
                                    to="/#programme"
                                    className={cx("py-2 border-b border-neutral-200", hashLinkClass("#programme"))}
                                >
                                    Programme
                                </Link>
                                <Link
                                ...
                                <Link
                                    to="/#impact"
                                    className={cx("py-2 border-b border-neutral-200", hashLinkClass("#impact"))}
                                >
                                    Impact
                                </Link>
                                <Link
